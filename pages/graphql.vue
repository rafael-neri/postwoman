      ...
      <div class="page-columns inner-left">
        ...
        <pw-section class="orange" label="headers" ref="headers">
          <ul v-if="headers.length !== 0">
            <li>
              <div class="flex-wrap">
                <label for="headerList">header_list</label>
                <div>
                  <button class="icon" @click="headers = []" v-tooltip.bottom="clear">
          ...
          <div class="flex-wrap">
            ...
            <div v-if="schema">
              <button
                ...
                v-tooltip="{
                  content: !expandResponse ? 'expand_response' : 'collapse_response',
                }"
              >
              ...
              <button
                ...
                ref="downloadSchema"
                v-tooltip="download_file"
              >
                <i class="material-icons">save_alt</i>
              </button>
              <button class="icon" ref="copySchemaCode" @click="copySchema" v-tooltip="copy_schema">
        ...
        <pw-section class="cyan" :label="query" ref="query">
          <div class="flex-wrap gqlRunQuery">
            ...
            <div>
              <button @click="runQuery()" v-tooltip.bottom="run_query">
                <i class="material-icons">play_arrow</i>
              </button>
              <button class="icon" @click="copyQuery" ref="copyQueryButton" v-tooltip="copy_query">
                <i class="material-icons">content_copy</i>
              </button>
              <button class="icon" @click="doPrettifyQuery" v-tooltip="'prettify_query'">
        ...
        <pw-section class="purple" label="Response" ref="response">
          ...
          <input
            v-else
            class="missing-data-response"
            :value="waiting_receive_response"
            ref="status"
            id="status"
            name="status"
            readonly
          ...
          <section>
            <tabs ref="gqlTabs">
              <div class="gqlTabs">
                ...
                <tab v-if="mutationFields.length > 0" :id="'mutations'" label="mutations">
                ...
                <tab v-if="gqlTypes.length > 0" :id="'types'" label="types" ref="typesTab">
...
export default {
  ...
  methods: {
    ...
    copySchema() {
      ...
      this.$toast.success("copied_to_clipboard", {
        icon: "done",
      })
    ...
    async runQuery() {
      ...
      try {
        ...
        this.$toast.info("finished_in", {
          icon: "done",
        })
      } catch (error) {
        this.response = `${error}. check_console_details`
        this.$nuxt.$loading.finish()

        this.$toast.error(`${error} f12_details`, {
          icon: "error",
        })
    ...
    async getSchema() {
      ...
      try {
        ...
        this.schema = `${error}. check_console_details`
        this.$toast.error(`graphql_introspect_failed`, {
          icon: "error",
        })
        console.log("Error", error)
      }
    ...
    downloadResponse() {
      ...
      this.$toast.success("download_started", {
        icon: "done",
      })
      setTimeout(() => {
