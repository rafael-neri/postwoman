      ...
      <div class="flex-wrap">
        ...
        <div>
          <button
            ...
            v-if="response.body"
            v-tooltip="{
              content: !expandResponse ? 'Expandir resposta' : 'Esconder resposta',
            }"
          >
          ...
          <button
            ...
            v-tooltip="{
              content: previewEnabled ? 'Esconder pré-visualização' : 'Pré-visualizar HTML',
            }"
          >
            <i class="material-icons">
