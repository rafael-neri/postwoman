<template>
  <div>
    <p class="info">
      Se está a gostar de utilizar o Postwoman, por favor considere fazer um donativo como sinal de
      agradecimento.
    </p>
    <p class="info">Pode apoiar o desenvolvimento do Postwoman com os seguintes métodos:</p>
    <div class="flex-wrap">
      <span>
        <a
    ...
    <div class="flex-wrap">
      <span>
        <a
          ...
          target="_blank"
          rel="noopener"
          v-tooltip.right="'Uma vez ou recorrente'"
        >
          <button class="icon">
