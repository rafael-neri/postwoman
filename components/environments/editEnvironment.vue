  ...
  <modal v-if="show" @close="hideModal">
    <div slot="header">
      <ul>
        <li>
          <div class="flex-wrap">
            <h3 class="title">Editar Ambiente</h3>
            <div>
    ...
    <div slot="body">
      ...
      <ul>
        <li>
          <div class="flex-wrap">
            <label for="variableList">Lista de variáveis</label>
            <div>
              <button class="icon" @click="clearContent($event)" v-tooltip.bottom="Limpar">
      ...
      <ul v-for="(variable, index) in this.editingEnvCopy.variables" :key="index">
        <li>
          <input
            :placeholder="'parâmetro ' + { count: index + 1 }"
            :name="'param' + index"
            :value="variable.key"
            @change="
        ...
        <li>
          <input
            :placeholder="'valor ' + { count: index + 1 }"
            :name="'value' + index"
            :value="
    ...
    <div slot="footer">
      <div class="flex-wrap">
        ...
        <span>
          ...
          <button class="icon primary" @click="saveEnvironment">Salvar</button>
        </span>
      </div>
    </div>
  </modal>
