  ...
  <modal v-if="show" @close="hideModal">
    <div slot="header">
      <ul>
        <li>
          <div class="flex-wrap">
            <h3 class="title">Importar / Exportar Ambiente</h3>
            <div>
          ...
          <div class="flex-wrap">
            <span
              v-tooltip="{
                content: !fb.currentUser ? 'login_first' : 'replace_current',
              }"
            >
    ...
    <div slot="footer">
      <div class="flex-wrap">
        ...
        <span>
          ...
          <button class="icon primary" @click="exportJSON" v-tooltip="'Baixar Arquivo'">
            Exportar
          </button>
        </span>
      </div>
...
export default {
  ...
  methods: {
    ...
    importFromPostwoman(environments) {
      let confirmation = "Arquivo Importado"
    ...
    exportJSON() {
      ...
      this.$toast.success("Transferência iniciada", {
        icon: "done",
      })
    },
    syncEnvironments() {
